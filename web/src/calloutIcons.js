// Lucide SVG icons used by Obsidian callouts.
// Stripped of `width`, `height` and `class` so the host CSS controls the size and color.
// `stroke="currentColor"` lets the icon inherit the callout title color in light and dark themes.
